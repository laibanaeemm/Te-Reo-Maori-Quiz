...
do
{
    ...
    char ans;
    int score1 = 0;
    Level1(); // this will call level 1.


    void Level1() // calls a method.
    {
    ...
    Console.WriteLine("I hope you had learned something from this and feel free to do this quiz as many times as you like"); //display conclusion
    Console.WriteLine("Goodbye");
    Console.WriteLine("Press enter to end the quiz or if you want to do it again, please press 'y'");
    choice = Convert.ToChar(Console.ReadLine());
    Console.Clear();
} while (choice == 'y' || choice == 'Y') ; // loops the program in case the user would like to do it again.
